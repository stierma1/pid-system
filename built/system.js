          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", pid._exit("normal", undefined, true));

              case 4:
                return _context3.abrupt("return", pid._exit(state, reason, true));
...
var Pid = function (_EventEmitter) {
  ...
  _createClass(Pid, [{
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", System.send(this, message));
    ...
    key: "_send",
    value: function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(message) {
        var commChannel;
        ...
        if (GroupControls[this._module] === this._func) {
          ...
          return function () {
            var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
              var message, out, _ref7, _ref8, receiver;
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 26:
                      return _context6.abrupt("return", System.recurse(self, promotedFunction));
    ...
    key: "receive",
    value: function receive(config, cb) {
      return System.receive(this, config, cb);
    }
  }, {
    key: "_receive",
    value: function _receive(message) {
      if (this.dictionary.debug) {
    ...
    value: function recurse(func) {
      return System.recurse(this, func);
    }
  }, {
    key: "exit",
    value: function exit(state, reason, catchProcess) {
      return System.exit(this, state, reason, catchProcess);
    }
  }, {
    key: "_exit",
    value: function _exit(state, reason, catchProcess) {
      this.state = state;
      this.reason = reason;
    ...
    key: "spawn",
    value: function () {
      var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(node, mod, func, clusterCookie, dict, views) {
        var pid;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                pid.process();
                return _context7.abrupt("return", pid);
...
var Registry = function () {
  ...
  _createClass(Registry, null, [{
    key: "register",
    value: function () {
      var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(name, pid) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                return _context9.abrupt("return", pid.node);
    ...
    key: "unregister",
    value: function () {
      var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(name) {
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                return _context11.abrupt("return", registry);
    ...
    key: "resolve",
    value: function () {
      var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(name) {
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                return _context12.abrupt("return", registry[name]);
...
var GroupControls = {
  ...
  race: function () {
    var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14() {
      ...
      var _ref16, _ref17, caller, racers, options, message, awaits, _ref19, _ref20, status, messageResponse;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 9:
              ...
              racers.map(function () {
                var _ref18 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(pid) {
                  var returnPid;
  ...
  fallback: function () {
    var _ref21 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15() {
      var _ref22, _ref23, caller, fallbacks, options, message, messageResponse, awaits, returnPid, _ref24, _ref25, status;
  ...
  all: function () {
    var _ref26 = _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {
      var _this5 = this;

      var _ref27, _ref28, caller, endpoints, options, message, self, awaits, isError, responses, _ref30, _ref31, status, messageResponse, idx;
          ...
          switch (_context17.prev = _context17.next) {
            ...
            case 9:
              ...
              endpoints.map(function () {
                var _ref29 = _asyncToGenerator(regeneratorRuntime.mark(function _callee16(pid, idx) {
                  var returnPid, opt;
  ...
  _receiver: function () {
    var _ref32 = _asyncToGenerator(regeneratorRuntime.mark(function _callee18() {
      var _this6 = this;

      var _ref33, _ref34, caller, options, message;
  ...
  _promised: function () {
    var _ref35 = _asyncToGenerator(regeneratorRuntime.mark(function _callee19() {
      var _ref36, _ref37, res, rej, _ref38, _ref39, status, message;
...
System.GroupControls.all = function () {
  var _ref40 = _asyncToGenerator(regeneratorRuntime.mark(function _callee20(caller, pids, options) {
    var allPid;
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          ...
          case 6:
            ...
            return _context20.abrupt("return", allPid);
...
System.GroupControls.allAsync = function (message, pids, options) {
  return new Promise(function () {
    var _ref41 = _asyncToGenerator(regeneratorRuntime.mark(function _callee21(res, rej) {
...
System.GroupControls.fallback = function () {
  var _ref42 = _asyncToGenerator(regeneratorRuntime.mark(function _callee22(caller, pids, options) {
    var fallBackPid;
      ...
      while (1) {
        switch (_context22.prev = _context22.next) {
          ...
          case 6:
            ...
            return _context22.abrupt("return", fallBackPid);
...
System.GroupControls.fallBackAsync = function (message, pids, options) {
  return new Promise(function () {
    var _ref43 = _asyncToGenerator(regeneratorRuntime.mark(function _callee23(res, rej) {
...
System.GroupControls.race = function () {
  var _ref44 = _asyncToGenerator(regeneratorRuntime.mark(function _callee24(caller, pids, options) {
    var racePid;
      ...
      while (1) {
        switch (_context24.prev = _context24.next) {
          ...
          case 6:
            ...
            return _context24.abrupt("return", racePid);
...
System.GroupControls.raceAsync = function (message, pids, options) {
  return new Promise(function () {
    var _ref45 = _asyncToGenerator(regeneratorRuntime.mark(function _callee25(res, rej) {
...
System.GroupControls.random = function () {
  var _ref46 = _asyncToGenerator(regeneratorRuntime.mark(function _callee26(caller, pids, options) {
    var randomPid;
      ...
      while (1) {
        switch (_context26.prev = _context26.next) {
          ...
          case 6:
            ...
            return _context26.abrupt("return", randomPid);
...
System.GroupControls.randomAsync = function (message, pids, options) {
  return new Promise(function () {
    var _ref47 = _asyncToGenerator(regeneratorRuntime.mark(function _callee27(res, rej) {
